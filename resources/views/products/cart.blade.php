...
<div class="container">
    <div class="row">
        <div class="col-md-12">
                        ...
                        <tr>
                            <td>
                                <figure class="media">
                                    <div class="img-wrap"><img
                                            src="{{asset('public/storage/'.$product['product']->thumbnail)}}"
                                            class="" width="100%" style=""></div>
                            ...
                            <td class="text-right">
                                <form action="{{route('cart.remove',$product)}}" method="POST" accept-charset="utf-8">
                                    ...
                                    <input type="submit" name="remove" value="x Remove"
            ...
            @else
            <p class="alert alert-danger">No Products in the Cart <a href="{{route('products.all')}}">Buy Some
                    Products</a></p>
            @endif
            @endsection
        </div>
